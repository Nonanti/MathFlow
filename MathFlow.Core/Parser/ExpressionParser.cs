...
public class ExpressionParser
{
	...
	private Expression CreateFunctionExpression(string functionName, List<Expression> arguments)
	{
		switch (functionName)
		{
			...
			case "binomial" or "choose" or "ncr" when arguments.Count == 2:
				return new FunctionExpression("binomial", arguments);

			case "perm" or "permutation" when arguments.Count == 2:
				return new FunctionExpression("perm", arguments);
